...
class ChessAssets: 
	...
	# 鼬乐园前往百鬼棋局 
	I_ENTERTAINMENT_GOTO_CHESS = RuleImage(roi_front=(304,175,41,127), roi_back=(304,175,41,127), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_entertainment_goto_chess.png")
	# 百鬼棋局标志 
	I_CHECK_CHESS = RuleImage(roi_front=(1159,592,66,70), roi_back=(1159,592,66,70), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_check_chess.png")
	# 商店 
	...
	# Image Rule Assets
	# 百鬼棋局局内页面标志 
	I_CHECK_CHESS_BATTLE = RuleImage(roi_front=(85,15,137,43), roi_back=(264,12,47,44), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_check_chess_battle.png")
	# 百鬼棋局主动退出 
	...
	# 百鬼棋局正常结算返回大厅 
	I_CHESS_EXIT_TO_LOBBY = RuleImage(roi_front=(384,591,172,47), roi_back=(340,570,270,100), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_chess_exit_to_lobby.png")
	# 百鬼棋局主动退出后返回大厅 
	I_CHESS_EXIT_TO_LOBBY_2 = RuleImage(roi_front=(580,593,123,43), roi_back=(580,593,123,43), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_chess_exit_to_lobby_2.png")
	# 百鬼棋局分享页 
	I_CHESS_SHARE = RuleImage(roi_front=(1138,560,107,113), roi_back=(1138,560,107,113), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_chess_share.png")
	# 百鬼棋局排名页 
	I_CHECK_CHESS_RANK = RuleImage(roi_front=(14,75,79,38), roi_back=(14,75,79,38), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_check_chess_rank.png")
	# 百鬼棋局排名页返回大厅 
	I_CHESS_RANK_GOTO_LOBBY = RuleImage(roi_front=(66,646,133,42), roi_back=(66,646,133,42), threshold=0.8, method="Template matching", file="./tasks/Chess/c/c_chess_rank_goto_lobby.png")
